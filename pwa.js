...
const cacheName = 'BIA3754B-2021-04-15 10:33:15.061081'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'BIA3754B'.length) === 'BIA3754B') {
